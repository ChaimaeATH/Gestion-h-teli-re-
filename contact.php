...
<head>
    ...
    <title>AMUZE - Contactez-nous</title>
...
<body class="bg-light">
  ...
  <?php 
    //session_start();
  require('inc/header.php'); ?> <!-- header link -->
  ...
  <div class="my-5 px-4">
    ...
    Contactez-nous en nous écrivant un message ou en appelant notre équipe du Amuze Hotel*****
    </p>
  </div>
      ...
      <div class="col-lg-6 col-md-6 mb-5 px-4">
        ...
        <div class="bg-white rounded shadow p-4">
          ...
          <a href="mailto: <?php echo $contact_r['email'] ?>" class="d-inline-block text-decoration-none text-dark">
            <i class="bi bi-inbox-fill"></i>  <?php echo $contact_r['email'] ?>
          </a>
      ...
      <div class="col-lg-6 col-md-6 px-4">
        <div class="bg-white rounded shadow p-4">
            <form method="POST">
              ...
              <div class="mt-3">
                <label class="form-label" style="font-weight: 500;">Commentaires *</label>
