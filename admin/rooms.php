...
<body class="bg-light">
    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                <h3 class="mb-4">TYPE CHAMBRES</h3>
            ...
            <form id="add_room_form" autocomplete="off">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Réglages > Ajouter une chambre</h5>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label fw-bold">Dans Une Chambre</label>
                                <div class="row">
                                    <?php 
    ...
    <div class="modal fade" id="edit-room" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form id="edit_room_form" autocomplete="off">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Réglages > Modifier une chambre</h5>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
    ...
    <!--  gérer Les Images Des Chambre modal -->
            ...
            <div class="modal-body">
                ...
                <div class="border-bottom border-3 pb-3 mb-3">
                    <form id="add_image_form">
                        ...
                        <button class="btn custom-bg text-align text-white shadow-none">ADD</button>
                        <input type="hidden" name="room_id">
                    </form>
                </div>
        ...
        function rem_image(img_id,room_id)
            {
                ...
                xhr.onload = function()
                {
                    if(this.responseText == 1){
                        ...
                        room_images(room_id,document.querySelector("#room-images .modal-title").innerHTML);
                    }
                    else{
